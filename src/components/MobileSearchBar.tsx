...
export default function MobileSearchBar({ lang }: { lang: Locale }) {
  ...
  return (
    <div ref={searchRef} className="relative w-full">
      ...
      {/* Search Results - Простое позиционирование для мобильных */}
      {showResults && (
        <div 
          className="absolute top-full left-0 right-0 mt-2 bg-white/98 dark:bg-gray-800/98 backdrop-blur-sm border border-gray-200 dark:border-gray-700 rounded-xl shadow-2xl overflow-y-auto z-[99999]"
          style={{ 

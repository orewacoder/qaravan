...
export default function SimpleSearchBar({ lang }: { lang: Locale }) {
  ...
  return (
    <div ref={searchRef} className="relative w-full z-[9999]">
      ...
      {/* Search Results */}
      {showResults && (
        <div className="absolute top-full left-0 right-0 mt-2 bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm border border-gray-200 dark:border-gray-700 rounded-xl shadow-2xl z-[9999] max-h-96 overflow-y-auto">
          {results.length > 0 ? (
            <div className="py-2">
